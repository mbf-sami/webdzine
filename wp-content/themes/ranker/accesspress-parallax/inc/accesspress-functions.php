...
function accesspress_parallax_bxslidercb(){
		...
		if( empty($accesspress_slider_category)) :
				...
				$loop = new WP_Query(array(
					...
					?>
					<div class="main-slides here" <?php echo $image_url; ?>>
            ...
            <div class="bx-slider">
				<div class="main-slides">
					...
					<div class="slider-caption">
						<div class="mid-content">
							<h1 class="caption-title"><?php _e('Limit are an illusion for speed of execution','accesspress-parallax'); ?></h1>
							<h2 class="caption-description">
							<p><?php _e('The services include, but are not limited by, the following!','accesspress-parallax'); ?></p>
							<p><a href="<?php echo get_bloginfo('url'); ?>/services"><?php _e('Read More','accesspress-parallax'); ?></a></p>
							</h2>
						</div>
					</div>
				</div>
